...
export const POI_BY_ID_LOADED = ' POI_BY_ID_LOADED'
export const POI_BY_MAP_YEAR_LOADED = 'POI_BY_MAP_YEAR_LOADED'
export const POI_BY_STORY_ID_LOADED = 'POI_BY_STORY_ID_LOADED'
