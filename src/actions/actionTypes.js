...
export const EXIT_STORY_MODAL = 'EXIT_STORY_MODAL'

//search pois
export const UNIVERSAL_SEARCH_INPUT_CHANGED = 'UNIVERSAL_SEARCH_INPUT_CHANGED'
export const POIS_UNIVERSAL_SEARCHED = 'POIS_UNIVERSAL_SEARCHED'
export const STORY_SEARCH_INPUT_CHANGED = 'STORY_SEARCH_INPUT_CHANGED'
export const POIS_STORY_SEARCHED = 'POIS_STORY_SEARCHED'
